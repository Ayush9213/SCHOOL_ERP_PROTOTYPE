...
my.execute("""
       INSERT INTO students (admission_number, classe, name, DOB, aadhar)
       VALUES
       (1001, 1, 'Aadhya Sharma', 2007, 2348903),
       (1002, 5, 'Aadhya Sharma', 2007, 2348903),
       (1003, 11, 'Advik Singh', 2009, 3458934),
       (1004, 11, 'Ananya Patel', 2000, 4812345),
       (1005, 11, 'Aradhya Gupta', 2005, 8901236);
  """)
